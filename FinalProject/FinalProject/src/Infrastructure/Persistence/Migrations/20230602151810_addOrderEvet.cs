...
{
    /// <inheritdoc />
    public partial class addOrderEvet : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FoundedCount = table.Column<int>(type: "int", nullable: true),
                    StartingDate = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: false),
                    FinishingDate = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true),
